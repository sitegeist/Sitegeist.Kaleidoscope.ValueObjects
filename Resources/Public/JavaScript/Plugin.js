/******/ ;(function (modules) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function createConsumerApi(manifests, exposureMap) {
                    ...
                    Object.defineProperty(
                        api,
                        '@manifest',
                        createReadOnlyValue(manifest_1['default'](manifests))
                    )
                ...
                function readFromConsumerApi(key) {
                    return function () {
                        ...
                        if (
                            ...
                            return (_a = window['@Neos:HostPluginAPI'])['@' + key].apply(
                                _a,
                                tslib_1.__spread(args)
                            )
                        }
                        throw new Error(
  ...
  \*************************************************************************************************************************************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var positionalArraySorter = function positionalArraySorter(
                    subject,
                    position,
                    idKey
                ) {
                    ...
                    try {
                        for (
                            var _h = tslib_1.__values(sortedWeights(startKeys, false)),
                                _j = _h.next();
                            !_j.done;
                            _j = _h.next()
                        ) {
                    ...
                    try {
                        for (
                            var _k = tslib_1.__values(sortedWeights(middleKeys, true)),
                                _l = _k.next();
                            !_l.done;
                            _l = _k.next()
                        ) {
                            ...
                            try {
                                for (
                                    var _r =
                                            ((e_5 = void 0),
                                            tslib_1.__values(
                                                sortedWeights(beforeKeys[key], false)
                                            )),
                                        _s = _r.next();
                                    !_s.done;
                                    _s = _r.next()
                        ...
                        for (
                            ...
                            try {
                                for (
                                    var _v =
                                            ((e_7 = void 0),
                                            tslib_1.__values(sortedWeights(afterKeys[key], false))),
                                        _w = _v.next();
                                    !_w.done;
                                    _w = _v.next()
                                ) {
...
***************************************************************************** */
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function registerAssetWithMetadataEditor(globalRegistry) {
                    ...
                    if (!inspectorRegistry) {
                        console.warn(
                            '[Sitegeist.Kaleidoscope.ValueObjects]: Could not find inspector registry.'
                        )
                        console.warn(
  ...
  \*************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var _kaleidoscopeValueobjectsAssetWithMetadataEditor = __webpack_require__(
                    /*! @sitegeist/kaleidoscope-valueobjects-asset-with-metadata-editor */ '../asset-with-metadata-editor/lib/index.js'
                )
                ...
                ;(0, _neosUiExtensibility2.default)(
                    '@sitegeist/kaleidoscope-valueobjects-plugin',
                    {},
                    function (globalRegistry, _ref) {
                        var store = _ref.store,
                            configuration = _ref.configuration,
                            routes = _ref.routes

                        var neosContextProperties = {
                        ...
                        ;(0,
                        _kaleidoscopeValueobjectsAssetWithMetadataEditor.registerAssetWithMetadataEditor)(
                            neosContextProperties,
                            editor
                        )
                    }
                )
